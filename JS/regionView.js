...
function clickSeoul() {
    ...
    document.getElementById("mainimg").src = "./koreaMapCollection/서울.png"
...
function clickGangwon() {
    ...
    document.getElementById("mainimg").src = "./koreaMapCollection/강원도.png"
...
function clickChungnam() {
    ...
    document.getElementById("mainimg").src = "./koreaMapCollection/충청남도.png"
...
function clickChungbuk() {
    ...
    document.getElementById("mainimg").src = "./koreaMapCollection/충청북도.png"
...
function clickGyeongnam() {
    ...
    document.getElementById("mainimg").src = "./koreaMapCollection/경상남도.png"
...
function clickGyeongbuk() {
    ...
    document.getElementById("mainimg").src = "./koreaMapCollection/경상북도.png"
...
function clickJeonnam() {
    ...
    document.getElementById("mainimg").src = "./koreaMapCollection/전라남도.png"
...
function clickJeonbuk() {
    ...
    document.getElementById("mainimg").src = "./koreaMapCollection/전라북도.png"
...
function clickJeju() {
    ...
    document.getElementById("mainimg").src = "./koreaMapCollection/제주도.png"
